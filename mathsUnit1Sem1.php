...
<div class="container">
	...
	<div>
	   ...
	   <div class="col-lg-8">
				<a id="a" href="" class="btn btn-default btn-lg btn-block" role="button"><h4>Asymptotes</h4></a>
				<a id="b" href="" class="btn btn-default btn-lg btn-block" role="button"><h4>Curvature</h4></a>
				<a id="c" href="" class="btn btn-default btn-lg btn-block" role="button"><h4>Curve Tracing</h4></a>
