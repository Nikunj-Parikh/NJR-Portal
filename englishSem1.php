...
<div class="container">
	...
	<div>
	   ...
	   <div class="col-lg-8">
				<a id="a" href="" class="btn btn-default btn-lg btn-block" role="button"><h4>Unit I (Grammar) </h4></a>
				<a id="b" href="" class="btn btn-default btn-lg btn-block" role="button"><h4>Unit II (Composition)</h4></a>
				<a id="c" href="" class="btn btn-default btn-lg btn-block" role="button"><h4>Unit III (Short Stories)</h4></a>
          		<a id="d" href="" class="btn btn-default btn-lg btn-block" role="button"><h4>Unit IV (Essays)</h4></a>
				<a id="e" href="" class="btn btn-default btn-lg btn-block" role="button"><h4>Unit V (Poems)</h4></a>
