...
<div class="container">
	...
	<div>
	   ...
	   <div class="col-lg-8">
				<a id="a" href="ChemUnit1Sem1.php" class="btn btn-default btn-lg btn-block" role="button"><h4>Unit I </h4></a>
				<a id="b" href="ChemUnit2Sem1.php" class="btn btn-default btn-lg btn-block" role="button"><h4>Unit II</h4></a>
				<a id="c" href="ChemUnit3Sem1.php" class="btn btn-default btn-lg btn-block" role="button"><h4>Unit III</h4></a>
          		<a id="d" href="ChemUnit4Sem1.php" class="btn btn-default btn-lg btn-block" role="button"><h4>Unit IV</h4></a>
				<a id="e" href="ChemUnit5Sem1.php" class="btn btn-default btn-lg btn-block" role="button"><h4>Unit V</h4></a>
