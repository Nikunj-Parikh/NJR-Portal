...
<div class="container">
	...
	<div>
	   ...
	   <div class="col-lg-8">
				<a id="a" href="mathsUnit1Sem1.php" class="btn btn-default btn-lg btn-block" role="button"><h4>Unit I (Differential Calculus) </h4></a>
				<a id="b" href="mathsUnit2Sem1.php" class="btn btn-default btn-lg btn-block" role="button"><h4>Unit II (Differential Calculus)</h4></a>
				<a id="c" href="mathsUnit3Sem1.php" class="btn btn-default btn-lg btn-block" role="button"><h4>Unit III (Integral Calculus)</h4></a>
          		<a id="d" href="mathsUnit4Sem1.php" class="btn btn-default btn-lg btn-block" role="button"><h4>Unit IV (Differential Equations)</h4></a>
				<a id="e" href="mathsUnit5Sem1.php" class="btn btn-default btn-lg btn-block" role="button"><h4>Unit V (Differential Equations)</h4></a>
