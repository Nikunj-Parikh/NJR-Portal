...
<div class="container">
	...
	<div>
	   ...
	   <div class="col-lg-8">
				<a id="a" href="" class="btn btn-default btn-lg btn-block" role="button"><h4>Differential  Equations  of First  Order  and  First  Degree </h4></a>
				<a id="b" href="" class="btn btn-default btn-lg btn-block" role="button"><h4>Linear Differential Equations with Constant Cofficients</h4></a>
