...
<div class="container">
	...
	<div>
	   ...
	   <div class="col-lg-8">
				<a id="a" href="" class="btn btn-default btn-lg btn-block" role="button"><h4>Volumes and Surface of Solids of Revolution</h4></a>
				<a id="b" href="" class="btn btn-default btn-lg btn-block" role="button"><h4> Double Integral</h4></a>
				<a id="c" href="" class="btn btn-default btn-lg btn-block" role="button"><h4>Beta Function and Gamma</h4></a>
