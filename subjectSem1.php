...
<div class="container">
	...
	<div>
	   ...
	   <div class="col-lg-8">
				<a id="a" href="englishSem1.php" class="btn btn-default btn-lg btn-block" role="button"><h4>Communicative English</h4></a>
				<a id="b" href="mathsSem1.php" class="btn btn-default btn-lg btn-block" role="button"><h4>Engineering Mathematics I</h4></a>
				<a id="c" href="physicsSem1.php" class="btn btn-default btn-lg btn-block" role="button"><h4>Engineering Physics I</h4></a>
          		<a id="d" href="chemistrySem1.php" class="btn btn-default btn-lg btn-block" role="button"><h4>Engineering Chemistry</h4></a>
				<a id="e" href="eeeSem1.php" class="btn btn-default btn-lg btn-block" role="button"><h4>Basic Electrical and Electronics Engineering</h4></a>
